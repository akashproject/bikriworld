...
<div style="overflow: auto;font-family: monospace;">
    <div style="width: 880px;padding: 20px 15px;margin: 15px auto;position: relative;z-index: 5;background: #ccc;">
       <main>
                ...
                <header style="padding-bottom: 25px; margin-bottom: 25px;">
                   <div style="display: flex;align-items: center!important;justify-content: space-between!important;flex-wrap: wrap;margin-top:12px;margin-left:12px;margin-right;:12px">
                      ...
                      <div style="width: auto;">
                         ...
                         text-align: right;"><b>Invoice No: </b>#935648</span>
                      </div>
                   </div>
                   <div style="border-bottom: 1px solid #CFD3DC;padding-bottom: 10px;margin-top: 26px;">
                        ...
                        <div style="width: auto;">
                            <p style="margin-bottom: 0;margin: 0 0 18px 0;margin-right: 1.5rem!important;line-height: 1.571;margin-right: 1.5rem!important;"><b>Invoice No: </b>#935648</p>
                        </div>
                        <div style="width: auto;">
                            <p style="margin-bottom: 0;margin: 0 0 18px 0;margin-right: 1.5rem!important;line-height: 1.571;"><b>Date : </b>12th Nov 2022</p>
                        </div>
                        </div>
                    </div>
                </header>
                <div style="display: flex;flex-wrap: wrap;margin-top:12px;margin-left:12px;margin-right;:12px;justify-content: space-between!important;margin-bottom: 1.5rem!important;">
                   <div style="width: auto;">
                      <div>
                         <b>Passenger Info:</b>
