@extends('layouts.main')
    ...
    <div class="section-padding">
        <div class="container">
            <form class="form-horizontal" id="checkoutform" method="post" action="{{ url('confirm-service-booking') }}" enctype="multipart/form-data">
                @csrf
                @if ($errors->any())
                ...
                <div class="row">
                    <div class="col-lg-8 mb-md-80">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <h3> Schedule Service Date Time </h3>                                
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group custom_form_style">
                        ...
                        <div class="sidebar style_3">
                            ...
                            <div class="sidebar_widget text-center">
                                ...
                                <div class="sidebar_widget_inner">
                                    ...
                                    <input type="hidden" name="amount" id="amount" value="{{ base64_encode($total) }}" >
                                    <input type="hidden" name="parts" id="parts" value="{{ $dataParts }}" >
                                    <button type="submit" class="sell-now-btn custom-cta-btn bg-thm-color-two btn-rectangle"> 
                                        Confirm Pickup <i class="fal fa-chevron-right ml-2"></i>
                                    </button>
                                </div>
                            </div>
                        </div>
