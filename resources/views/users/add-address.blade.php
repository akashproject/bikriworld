                        ...
                        <div class="row ">
                            <div class="col-lg-4">
                                <div class="form-group custom_form_style">
                                    ...
                                    <input type="text" value="" name="address_1" class="form-control" autocomplete="off" >
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group custom_form_style">
                                    <label class="padding-30px-left-right">City <span class="required">*</span></label>
                                    <input type="text" value="" name="city" class="form-control" id="city" autocomplete="off" >
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group custom_form_style">
                                    <label class="padding-30px-left-right">State <span class="required">*</span></label>
                                    <input type="text" value="" name="state" class="form-control" autocomplete="off" >
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group custom_form_style">
                                    <label class="padding-30px-left-right">Pincode<span class="required">*</span></label>
                                    <input type="text"  name="pincode" class="form-control" autocomplete="off">
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group custom_form_style">
                                    <label class="padding-30px-left-right">Landmark<span class="required">*</span></label>
                                    <input type="text" value="" name="landmark" class="form-control" autocomplete="off">
                                </div>
                            </div>                           
                        </div>
