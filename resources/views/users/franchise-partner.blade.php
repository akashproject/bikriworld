...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
   ...
   <body>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-5">
                        <div  id="banner-lead-form" class="image_box relative">
                            <form class="form-horizontal" id="franchise-lead-form" method="post" action="{{ route('save-franchise') }}" enctype="multipart/form-data" style="border-radius: 10px;overflow: hidden;">
                                @csrf
                                @if ($errors->any())
                                ...
                                <div class="row">
                                    ...
                                    "> <span style="
                                        color: #ff0000;
                                    ">Submit Details </span>  to JOIN US </h4>
                                    </div>
                                </div>
                                <div class="row" style="background: #6462626e;padding: 20px;">
                                    <div class="col-lg-12 mt-2">
                                        <div class="form-group custom_form_style">
                                            <label>Full Name</label>
                                            <input type="text" name="name" class="form-control" autocomplete="off" placeholder="Please Enter Your Full Name" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 mt-2">
                                        <div class="form-group custom_form_style">
                                            <label>Phone Number</label>
                                            <input type="text" name="mobile" class="form-control" autocomplete="off" placeholder="Please Enter Your Phone Number" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 mt-2">
                                        <div class="form-group custom_form_style">
                                            <label>Email Address</label>
                                            <input type="email" name="email" class="form-control" autocomplete="off" placeholder="Please Enter Your Email Address" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 mt-2">
                                        <div class="form-group custom_form_style">
                                            <label>Do you have Trade License/GSTIN</label>
                                            <select type="text" name="document_satus" class="form-control" autocomplete="off" required>
                                    ...
                                    <div class="col-lg-12 mt-2">
                                        <div class="form-group custom_form_style">
                                            <label>City</label>
                                            <input type="text" name="city" class="form-control" autocomplete="off" placeholder="Enter Area/City of Your Business " required>
                                        </div>
                                    </div>

                                    <div class="col-lg-12 mt-2">
                                        <div class="form-group custom_form_style">
                                            <label>Please Select Model You want to DEAL</label>
                                            <div class='row'>
                                                <div class="col-4" >
                                                    <input type="checkbox" name="dealing_model[]" value="Laptop" > Laptop 
                                                </div>
                                                <div class="col-4" >
                                                    <input type="checkbox" name="dealing_model[]" value="Macbook" > Macbook 
                                                </div>
                                                <div class="col-4" >
                                                    <input type="checkbox" name="dealing_model[]" value="Mobile" > Mobile 
                                                </div>
                                                <div class="col-4" >
                                                    <input type="checkbox" name="dealing_model[]" value="Tablet" > Tablet 
                                                </div>
                                                <div class="col-4" >
                                                    <input type="checkbox" name="dealing_model[]" value="DSLR" > DSLR 
                                                </div>
                                                <div class="col-4" >
                                                    <input type="checkbox" name="dealing_model[]" value="Televison" > Televison 
                                                </div>
                                                <div class="col-4" >
                                                    <input type="checkbox" name="dealing_model[]" value="Air Conditioner" > Air Conditioner 
                                                </div>
                                                <div class="col-4" >
                                                    <input type="checkbox" name="dealing_model[]" value="Motorcycle" > Motorcycle 
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <section class="ad_why_choose_section my-5" id="why-us">
        <div class="container">
            <div class="text-center">
                <h4> How To Become a <span style="color: #007653;font-weight: 600;">Bikriworld Partner?</span> </h4>                
            </div>
            <div class="row">
                <div class="col-md-3">
